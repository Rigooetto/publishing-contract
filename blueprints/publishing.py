...
def formulario():
    ...
    if request.method == "POST":
        ...
        first_names = request.form.getlist("lm_wfn")
        middle_names = request.form.getlist("lm_wmn")
        last_names_list = request.form.getlist("lm_wln")
        writer_akas = request.form.getlist("lm_waka")
        ipis = request.form.getlist("writer_ipi")
        emails = request.form.getlist("lm_wem")
        phones = request.form.getlist("lm_wph")
        ...
        addresses = request.form.getlist("lm_waddr")
        cities = request.form.getlist("lm_wcty")
        states = request.form.getlist("lm_wst")
        zip_codes = request.form.getlist("lm_wzip")
